...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full top-0 z-50 transition-all duration-700 ${scrolled ? 'bg-[#050505]/90 backdrop-blur-xl border-b border-white/5 py-4' : 'bg-transparent py-8'} h-20 md:h-24 flex items-center`}>
